-- סיווג עמודי הכניסה שנוספו למדידה ב-6/8/26.
--
-- הרקע: עמודים ציבוריים רבים לא שלחו שום אירוע, ולכן פשוט לא היו קיימים
-- באדמין - כולל מאמרי /research (שם יושב מדריך המילואים), עמוד "מי אנחנו",
-- "בית למפתחים", עמוד המידע למרכזים ועמודי הרכזת (אינדקס נושאים/גישות/
-- אזורים/אבחונים/הסדרים/מאמרים). נחיתה עליהם מגוגל נזקפה בטעות לעמוד שהמבקר
-- לחץ עליו אחר כך.
--
-- עמודי תדמית/מידע (about / developers / centers-info) מקובצים כ-'info' ולא
-- כ-'demand': מי שקורא "מי אנחנו" אינו מחפש טיפול. הם נספרים עם הגיוס בגרף
-- השבועי, כדי ש"ביקוש" יישאר מדד נקי.
