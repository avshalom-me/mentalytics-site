...
const EFT_ITEMS = ["ריחוק/עוינות/ריבים תכופים","בדידות/ייאוש","אחד מבני הזוג עם חרדה/דיכאון/טראומה","תחושת ניתוק/'תקועים' במעגל חוזר","קושי בביטוי רגשות","קושי בוויסות רגשות","חשש מנטישה/הימנעות מקרבה"];
const DYN_ITEMS = ["קשיים באינטימיות מינית","רצון בתהליך עמוק וארוך","סקרנות לגבי העולם הפנימי","טראומות עבר","קשיים נפשיים אישיים","הגדרת עצמכם כ'מחפשי תובנות'","רצון להבין את עצמנו ואת בן/בת הזוג"];
const STRUCT_ITEMS = ["קונפליקטים על חלוקת תפקידים","קשר קרוב מדי עם משפחת מוצא","נתק ממשפחה/משאבי תמיכה","מאבקי כוח בתוך היחסים","חיבור לגישה פרקטית לשינוי","רמת כאב זוגי גבוהה","פער גדול באופי בין בני הזוג"];
const PORN_ITEMS = [
  ...
  if (screen === "therapist-style") return (
    <Layout>
      <Card badge="סגנון טיפול מועדף" badgeColor="teal">
        ...
        <ScaleRow label="כדי ליצור שינוי אמיתי בחיי, אני מאמין/ה שעלי קודם כל להבין לעומק את שורשי הבעיה בעברי ואת הדפוסים הלא-מודעים שמנהלים אותי." sublabel="1 = מסכים/ה מאוד – מחפש/ת תובנה עמוקה  |  7 = בכלל לא מסכים/ה – מעדיף/ה הקלה מיידית ומעשית" group="ts-q1" values={[1,2,3,4,5,6,7]} value={styleQ1} onChange={setStyleQ1} />
  ...
  if (screen === "r2-q") return (
    <Layout>
      <Card badge="שאלון טיפול זוגי">
        <p className="mb-3 font-semibold text-[#1a3a5c]">דרג/י כל היגד מ-1 עד 7 עבור הזוגיות שלך:</p>
