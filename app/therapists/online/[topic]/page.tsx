...
const ONLINE_NOTES: Record<string, string> = {
  "טיפול-בחרדה":
    "דווקא בחרדה יש לטיפול אונליין בסיס מחקרי חזק במיוחד: מטא-אנליזה של טיפול בשיחת וידאו (Fernandez ועמיתיו, 2021) מצאה שהאפקט הבולט ביותר נמדד ב-CBT לחרדה, לדיכאון ולפוסט-טראומה. יש גם יתרון מעשי שמטופלים מדווחים עליו שוב ושוב: כשההגעה לקליניקה היא בעצמה מקור לחרדה - פקקים, אוטובוסים, מרחב ציבורי - הפגישה מהבית מסירה את המחסום שמונע להתחיל. חשוב רק לזכור שבחרדה העבודה כוללת לרוב גם חשיפה הדרגתית למצבים אמיתיים, והמטפל ילווה אתכם בה גם מרחוק.",
  "טיפול-בדיכאון":
    "טיפול אונליין בדיכאון נחקר רבות: המטא-אנליזה העדכנית ב-World Psychiatry (Hedman-Lagerlöf ועמיתיו, 2023) מצאה שקילות מלאה בין טיפול מבוסס-אינטרנט בליווי מטפל לבין טיפול פנים אל פנים, וטיפול בווידאו נמצא יעיל במיוחד ב-CBT לדיכאון (Fernandez ועמיתיו, 2021). בדיכאון יש לפורמט גם יתרון ייחודי: בימים שבהם לצאת מהבית מרגיש בלתי אפשרי, הפגישה מתקיימת בכל זאת - במקום להתבטל. רצף כזה הוא בדיוק מה שמגן על הטיפול בתקופות הקשות.",
  "פסיכולוג-ילדים":
    "כאן נדרשת כנות: עם ילדים צעירים, טיפול רגשי עובד דרך משחק ונוכחות משותפת בחדר, ולכן פגישות וידאו מתאימות פחות לגיל הרך. מה שכן עובד מצוין אונליין הוא הדרכת הורים - שפעמים רבות היא ממילא המנוף המרכזי בטיפול בילד - וכן עבודה עם ילדים גדולים יותר שכבר נוח להם מול מסך. הרבה משפחות משלבות: הילד נפגש עם המטפל בקליניקה, וההורים מקבלים את ההדרכה בווידאו בשעות הערב, בלי סידורים ובלי בייביסיטר.",
  "פסיכולוג-לנוער":
