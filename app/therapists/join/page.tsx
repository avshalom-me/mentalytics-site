...
const faqs = [
  {
    q: "למי זה מתאים?",
    a: 'רק מטפלים מורשים בעלי תעודה מקצועית מוכרת יכולים להירשם: פסיכולוגים, עובדים סוציאליים, מטפלים בהבעה ויצירה, קלינאי תקשורת, מרפאים בעיסוק, פיזיותרפיסטים, פסיכיאטרים, יועצים חינוכיים, מטפלים מיניים ומטפלים זוגיים וכד׳. בעת ההרשמה תתבקש/י להעלות את התעודות שלך, ואנו מאמתים אותן לפני אישור הפרופיל. התעודות משמשות לבדיקה פנימית בלבד ואינן מוצגות בפרופיל או באתר.',
  },
  {
