...
export default function CitySeoSection({
  ...
  const costA =
    priceContext +
    (kind === "online"
      ? // Same range as /research/online-therapy (owner's call, 25/9/2026 - this
        // line said 280 while the article said 300).
        `בטיפול אונליין הטווח רחב במיוחד - לרוב בין 300 ל־550 ש״ח לפגישה - כי אפשר לבחור מטפל מכל אזור בארץ, כולל אזורים שבהם התעריפים נמוכים יותר.`
      : h % 2 === 0
