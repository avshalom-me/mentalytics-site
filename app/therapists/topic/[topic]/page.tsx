    ...
    <main className="mx-auto max-w-6xl px-5 py-10 pb-20" dir="rtl" style={{ fontFamily: "'Heebo', sans-serif" }}>
      ...
      <div className="mb-8">
        ...
        <p className="mt-3 text-stone-600 leading-8" style={{ maxWidth: "60ch" }}>
          {topic.kind === "gender"
            ? `${topic.name}: מלאו שאלון מקצועי שפותח על ידי פסיכולוגים קליניים ומצאו את ההתאמה הנכונה עבורכם, או עברו על רשימת המטפלות שתעודות ההכשרה שלהן אומתו ופנו ישירות${onlineHere > 0 ? " (חלקן זמינות גם אונליין)" : ""}. בחינם וללא התחייבות.`
