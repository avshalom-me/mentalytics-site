          ...
          <div className="px-6 pt-6 pb-5">
            ...
            {showRefundNote && (
              <div className="mt-3 rounded-xl bg-white/10 border border-white/20 px-4 py-3 text-xs text-white/80 leading-5">
                * ההחזר הכספי מכסה את דמי המנוי של החודשיים בהם הייתם מנויים. ההחזר ניתן רק אם לא התקבלה אף לחיצה על פנייה (הודעה דרך האתר, או לחיצה על וואטסאפ/טלפון/מייל בפרופיל) בשני החודשים העוקבים ממועד ההצטרפות.
              </div>
            )}
            <div className="mt-5">
