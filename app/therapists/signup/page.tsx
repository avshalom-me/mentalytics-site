...
function LandingScreen() {
  const benefits = [
    ...
    {
      icon: "🤝",
      title: "התאמה אישיותית",
      body: "מעבר להתמחות — המערכת בוחנת את הסגנון הטיפולי שלך ומתאימה אותו למטופלים שמחפשים בדיוק את הגישה שלך.",
    },
    {
      icon: "📊",
      title: "פרמטרים מגוונים",
      body: "התאמה לפי גיל, אזור, שפה, העדפה תרבותית, הסדרי ביטוח ועוד — כדי שתגיעו בדיוק לקהל הנכון.",
    },
    {
      icon: "🔒",
      title: "שקיפות ובקרה",
      body: "אתה שולט בפרטים שמוצגים, ויכול לעדכן את הפרופיל בכל עת. כל הגשה נסקרת לפני פרסום.",
    },
  ];
      ...
      <div className="mx-auto max-w-2xl px-4 py-10">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-3 text-stone-800 leading-7 max-w-lg mx-auto">
            טיפול חכם היא מערכת הפניה חכמה שמחברת בין מטופלים לאנשי טיפול —
        ...
        <div className="space-y-4 mb-8">
          {benefits.map((b, i) => (
            <div key={i} className="flex gap-4 rounded-2xl bg-white p-5 shadow-sm"
