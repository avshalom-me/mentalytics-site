...
function TherapistCard({
  ...
  return (
    ...
    >
      ...
      <div className="px-4 pb-4 flex flex-wrap items-center gap-2 border-t border-stone-100 pt-3">
        {t.phone && (
          <a href={`tel:${t.phone}`}
            onClick={() => trackClick(t.id, "phone")}
            className="inline-flex items-center gap-1.5 rounded-xl bg-stone-100 px-3 py-1.5 text-xs font-bold text-stone-700 hover:bg-stone-200">
