  ...
  return (
    ...
    >
      ...
      <section className="mt-14 fade-up fade-up-4" dir="rtl">
        <h2 className="mb-2 text-2xl font-extrabold text-stone-900">אז איך זה עובד?</h2>
        <p className="mb-6 text-sm text-stone-500">בסוף השאלון תקבלו כרטיסי התאמה כאלה — לדוגמה:</p>
        ...
        <div className="rounded-2xl border border-[#E8E0D8] bg-white overflow-hidden max-w-sm mx-auto" style={{ boxShadow: "0 4px 24px rgba(60,40,20,.10)" }}>
          ...
          {/* Info */}
          <div className="p-5">
            <div className="font-black text-stone-900 text-lg leading-tight">זיגמונד פרויד</div>
            <div className="text-[#2e7d8c] text-sm font-semibold mt-0.5">פסיכולוג קליני</div>

            <div className="mt-3 flex flex-wrap gap-1.5">
              <span className="rounded-full bg-stone-100 border border-stone-200 px-2.5 py-0.5 text-xs text-stone-600">📍 יבנה</span>
              <span className="rounded-full bg-blue-50 border border-blue-200 px-2.5 py-0.5 text-xs text-blue-700">🌐 אונליין</span>
              <span className="rounded-full bg-stone-100 border border-stone-200 px-2.5 py-0.5 text-xs text-stone-600">🗣 עברית, גרמנית</span>
            </div>

            <p className="mt-3 text-xs text-stone-600 leading-6">
            ...
            {/* Reasons */}
            <div className="mt-4 rounded-xl bg-stone-50 border border-stone-100 px-4 py-3 text-xs text-stone-600 space-y-1">
              <div>✓ התאמה בתחום המומחיות: טיפול דינמי</div>
              <div>✓ התאמה בהעדפת מגדר</div>
              <div>✓ מציע טיפול אונליין</div>
            </div>

            {/* Buttons */}
            <div className="mt-4 flex gap-2">
              <span className="inline-flex items-center gap-1.5 rounded-xl bg-green-500 px-3 py-2 text-xs font-bold text-white opacity-80 cursor-default">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-xl bg-stone-700 px-3 py-2 text-xs font-bold text-white opacity-80 cursor-default">
              ...
              <span className="mr-auto text-xs font-semibold text-[#2e7d8c] self-center opacity-70 cursor-default">פרופיל מלא ←</span>
            </div>

            <p className="mt-4 text-center text-xs text-stone-400 italic">* זוהי הדמיה בלבד לצורך המחשה</p>
          </div>
        </div>
      </section>
