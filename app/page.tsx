...
const faqs = [
  ...
  },
  {
    ...
    a: "ניתן להשתמש 6 פעמים בשאלון. לאחר מכן תשלום סמלי של 30 שקלים + מע\"מ. לרוב אין צורך ביותר מפעם או פעמיים.",
  },
  {
    q: "כמה זמן זה לוקח?",
              ...
              <div className="max-w-2xl fade-up fade-up-1">
                ...
                <div className="mt-6 flex flex-col gap-3 fade-up fade-up-2">
                  ...
                  <TrustBadge
                    icon={Coins}
                    color="#8B2E0A"
                    text="ניתן להשתמש 6 פעמים בשאלון, לאחר מכן תשלום סמלי של 30 שקלים + מע&quot;מ. לרוב אין צורך ביותר מפעם או פעמיים."
                  />
                  <TrustBadge
                    icon={Heart}
                    color="#9B4F80"
            ...
            <li className="rounded-2xl border border-[#E8E0D8] bg-white px-4 py-3 flex gap-3 items-center" style={{ boxShadow: "0 2px 12px rgba(60,40,20,.07)" }}>
              <span className="text-sm text-stone-600">
                ...
                <details className="inline">
                  ...
                  <span className="block mt-1 text-xs text-stone-500 leading-relaxed">בשימוש הוגן. מעל 6 שימושים ישנו תשלום סמלי של 30 ש״ח + מע&quot;מ.</span>
                </details>
              </span>
            </li>
          </ol>
