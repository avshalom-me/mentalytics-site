...
const faqs = [
  ...
  },
  {
    ...
    a: "לא. השימוש בשאלונים אנונימי לחלוטין ואין צורך להוסיף פרטים מזהים.",
  },
  {
    q: "כמה פעמים אפשר להשתמש בשאלון ומה העלות?",
    a: "ניתן להשתמש 3 פעמים בשאלון. לאחר מכן תשלום סמלי של 20 שקלים. לרוב אין צורך ביותר מפעם או פעמיים.",
  },
  {
    q: "כמה זמן זה לוקח?",
              ...
              <div className="max-w-2xl fade-up fade-up-1">
                ...
                <p className="mt-5 leading-8 text-stone-700">
                  ...
                  <span className="font-bold" style={{ color: "#0F5468" }}>
                    אישיות המטופל לדרך המקצועית והאישיות של המטפל
                  </span>
                ...
                >
                  ...
                  <p className="mt-2 leading-7 text-stone-700">
                    ...
                    הטיפול ואת איש הטיפול המתאים ביותר עבורכם. אין צורך בידע מוקדם,
                    הכל קורה בצורה פשוטה, ברורה וחמה.
                  </p>
                </div>
                ...
                <div className="mt-6 flex flex-col gap-3 fade-up fade-up-2">
                  <TrustBadge
                    icon={Lock}
                    color="#0F5468"
                    text="השימוש בשאלונים אנונימי לחלוטין ואין צורך להוסיף פרטים מזהים."
                  />
                  <TrustBadge
                    icon={Coins}
                    color="#8B2E0A"
                    text="ניתן להשתמש 3 פעמים בשאלון, לאחר מכן תשלום סמלי של 20 שקלים. לרוב אין צורך ביותר מפעם או פעמיים."
                  />
                  <TrustBadge
                    icon={Heart}
                    color="#9B4F80"
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            },
            {
              icon: "🤝",
              title: "התאמה אישית",
              body: "סוג הטיפול הנכון ואיש הטיפול המתאים יכולים לשנות הכל. אנחנו עוזרים לכם למצוא את ההתאמה.",
              bg: "#EBF5F1",
              border: "#A8D4C0",
            },
            {
