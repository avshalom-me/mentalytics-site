      ...
      <div className="space-y-8 text-sm leading-7 text-stone-700">
        ...
        <section>
          ...
          <ul className="list-disc pr-6 mt-2 space-y-1">
            ...
            <li>מייל: <a href="mailto:tpool406@gmail.com" className="underline hover:text-[#0F5468]">tpool406@gmail.com</a></li>
        ...
        <section>
          ...
          <ul className="list-disc pr-6 mt-2 space-y-1">
            <li><strong>מנוי חודשי למטפלים (מסלול מקודם):</strong> מנוי מתחדש בעלות של 140 ש&quot;ח לחודש (לא כולל מע&quot;מ). כולל הופעה במערכת ההתאמה החכמה, סטטיסטיקות מתקדמות, ודו&quot;חות פילוח פניות.</li>
            <li><strong>שימוש בשאלון התאמה (מטופלים):</strong> ששת השימושים הראשונים חינמיים. כל שימוש נוסף בעלות של 30 ש&quot;ח (לא כולל מע&quot;מ).</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">ביטול מנוי ניתן לבצע דרך פנייה למייל <a href="mailto:tpool406@gmail.com" className="underline hover:text-[#0F5468]">tpool406@gmail.com</a> או בטלפון <a href="tel:0527906335" className="underline hover:text-[#0F5468]">052-790-6335</a>.</p>
        </section>
