...
const DESCRIPTION =
  "ביטוח לאומי מממן טיפול נפשי רק בחלק מהמסלולים, ובאחרים משלם קצבה בלבד. המפה המלאה: נפגעי איבה, נפגעי עבודה ונכות כללית - מי זכאי למה, ולמה כדאי להתחיל מוקדם.";
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "רק בחלק מהמסלולים. בנפגעי פעולות איבה ובנפגעי עבודה הביטוח הלאומי אחראי על הריפוי ולכן מממן טיפול נפשי בפועל. בנכות כללית הוא משלם קצבה כספית, והטיפול עצמו מתקבל דרך קופת החולים. זו ההבחנה שהכי מבלבלת פונים.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "החלון משתנה לפי המסלול: 30 יום בנכות מעבודה ו-60 יום בנכות כללית. על החלטת ועדת העררים אפשר לערער לבית הדין האזורי לעבודה בתוך 60 יום, אך רק בשאלות משפטיות ולא על שיקול הדעת הרפואי. לערעורים אלה קיים סיוע משפטי חינם ללא מבחן הכנסה.",
      },
    },
  ],
};
