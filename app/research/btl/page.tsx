...
const faqLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "כן, במסלול אחד. מי שנכח באירוע איבה וסובל מתגובת חרדה זכאי לטיפול נפשי במימון מלא בלי להגיש תביעת הכרה ובלי ועדה רפואית - עד 12 טיפולים, ובהתאם להערכת המטפל הרחבה עד 36. הטיפול ניתן במרכזי חוסן, במוקדי קופות החולים וביחידות בבתי חולים.",
      },
    },
    {
      "@type": "Question",
