...
export const metadata: Metadata = {
  title: "פסיכולוג מומלץ - איך למצוא פסיכולוג טוב שמתאים לכם | טיפול חכם",
  description:
    "מה זה בעצם 'פסיכולוג מומלץ', ולמה רשימת המלצות גנרית לא מספיקה. איך למצוא פסיכולוג טוב שמתאים דווקא לכם - לפי התמחות, גישה, כימיה, מיקום ועלות - כולל שאלות לשיחת ההיכרות.",
  keywords: [
    "פסיכולוג מומלץ",
