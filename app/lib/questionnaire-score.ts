    ...
    if (f.f1 && f.f1Attention) {
      ...
      if (adhd1 >= 3) {
        recs.push({
          ...
          urgent: false,
          notes: "יש לפנות לנוירולוג או פסיכיאטר המומחים בקשיי קשב לאבחון ובחינת טיפול תרופתי. בנוסף, ניתן לשקול נוירופידבק — טיפול מבוסס-ביופידבק של גלי מוח שנמצא יעיל לקשיי קשב במחקרים מבוקרים, כחלופה או כתוספת לטיפול תרופתי.",
        });
      }
      if (adhd2 >= 3) {
        recs.push({
