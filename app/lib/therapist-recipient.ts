...
// הכתובת שהמרכז הקליד בהזמנה - לפעמים תיבת המרכז עצמה, ואצל מטפלת של אחד
// המרכזים מחרוזת ריקה, כלומר המייל פשוט לא יצא.
//
 ...
 * למטפל כתובת משלו. הנפילה קיימת כי החלופה גרועה יותר: מטפלת של אחד המרכזים,
 ...
 * (כך אצל מטפל באחד המכונים). בשניהם קורא המייל הוא צוות המרכז, ולכן שניהם
