...
export const GAD7_ITEMS = [
  ...
  'קשיי ריכוז: תחושה שהמוח "ננעל" או "מתרוקן", או מוסחות גבוהה עקב מחשבות החרדה',
  "עצבנות ותגובות מתוחות ומיידיות",
  ...
  "הימנעות ממצבים, מקומות, אנשים או פעילויות שמעוררים תחושות של חרדה ומתח",
...
// Cut from 7 items per approach to 4 on 13/8/2026. This was the heaviest screen
// in the questionnaire (21 seven-point scales, the site's longest median dwell
// and its highest mid-quiz exit rate) and the scoring only ever compares the
// three block sums, so items kept are the ones that DISCRIMINATE between the
// approaches - generic couple-distress items that would score high under any
// approach were the ones dropped. Selection approved by the clinician 13/8/26.
...
export const KIDS_MQ_ITEMS = [
  ...
  { key: "mq5", label: "5. מחשבה ודיבור איטיים, ופחות תנועות גופניות" },
...
export const KIDS_AG_ITEMS = [
  ...
  { key: "ag4", label: "4. ניסיונות כושלים לצמצם שימוש במשחקים" },
...
export const KIDS_OQ_ITEMS = [
  ...
  { key: "oq2", label: "2. מחשבות רעות שמתקשה להפסיק" },
...
export const KIDS_TQ_ITEMS = [
  ...
  { key: "tq3",  label: "3. מתאר/ת תחושות של הזעה או דופק מהיר כשנזכר באירוע הטראומטי" },
...
export const KIDS_BQ_ITEMS = [
  ...
  { key: "bq2", label: "2. חוסר ביטחון משמעותי" },
