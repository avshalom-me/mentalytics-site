...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    kind: "audience",
    intro:
      "גיל ההתבגרות מזמן טלטלות אמיתיות — זהות, חברה, לחצים לימודיים, מסכים — ולעיתים גם חרדה, דכדוך או פגיעה עצמית. מתבגרים זקוקים למטפל שמדבר בגובה העיניים ויודע לבנות אמון גם עם מי ש\"לא בא לו\". טיפול בנוער משלב לרוב עבודה פרטנית עם קשר להורים במינון מותאם.",
  ...
  },
  {
    ...
    kind: "audience",
    intro:
      "פרישה, אובדן, בדידות, התמודדות עם מחלה או פשוט פרק חיים חדש — טיפול רגשי בגיל השלישי הוא תחום מתפתח עם עדויות טובות ליעילות. מטפלים המנוסים בעבודה עם ותיקים יודעים לכבד ניסיון חיים עשיר ולעבוד בקצב הנכון; טיפול אונליין פותח נגישות גם למי שהניידות מאתגרת.",
