...
export const TOPICS: Topic[] = [
  ...
  {
    // Religious and Haredi searchers look for "פסיכולוגית דתיה", "פסיכולוג דתי
    // בירושלים", "מטפלת רגשית חרדית" - 89 impressions across 21 terms in the ads
    // search-term report on 18/9/2026, concentrated in Jerusalem.
    //
    // The field underneath is cultural_prefs, and it records FAMILIARITY
    // ("היכרות עם העולם הדתי"), not the therapist's own identity: 110 of ~200
    // listed therapists ticked it, and the same list offers
    // "היכרות עם עולם הלהט"ב", which 86 ticked. A page titled "פסיכולוג דתי"
    // would promise a religious therapist and deliver, in part, secular ones
    // who know the world. So the owner chose the wording (18/9/2026):
    // "פסיכולוגים לדתיים" - for religious people, not necessarily religious
    // themselves. The first FAQ answer says so in plain words, because that is
    // the question a religious patient will actually have.
    //
    // Two topics, not one: the data holds two separate fields (110 vs 73), and
    // a Haredi family searching "פסיכולוגית חרדית" is not served by a list of
    // therapists who know the religious-Zionist world.
    slug: "פסיכולוג-לדתיים",
    name: "פסיכולוגים לדתיים",
    searchTitle: "פסיכולוגים לדתיים - מטפלים שמכירים את העולם הדתי",
    kind: "community",
    intro:
      "למטופל דתי, חלק גדול מהשאלה אם טיפול יעבוד הוא האם יצטרך להסביר למטפל את העולם שלו מאפס - שבת, צניעות, מקומו של הרב, המשפחה והקהילה - והאם האמונה עצמה תיתפס כחלק מהבעיה. מטפל שמכיר את העולם הדתי חוסך את זה, ועובד בתוך הערכים של המטופל ולא מולם. המטפלים כאן ציינו היכרות עם העולם הדתי. חלקם דתיים בעצמם וחלקם לא, ואם זה חשוב לך, כדאי לשאול בשיחה הראשונה.",
    cityTitleTail: "מטפלים שמכירים את העולם הדתי",
    faq: [
      { q: "האם המטפלים בעמוד הזה דתיים בעצמם?", a: "לא בהכרח, וחשוב לומר את זה במפורש. המטפלים שמוצגים כאן ציינו שהם מכירים את העולם הדתי - את אורח החיים, את הערכים ואת המתחים שבתוכו. חלקם דתיים בעצמם וחלקם לא. עבור רוב המטופלים מה שחשוב באמת הוא שלא יצטרכו להסביר ולהצדיק את עולמם, ושהאמונה לא תיתפס כחלק מהבעיה. אם חשוב לך שהמטפל/ת יהיו דתיים בעצמם, זו שאלה לגיטימית לגמרי, ואפשר לשאול אותה ישירות בשיחה הראשונה." },
      { q: "למה חשוב שהמטפל יכיר את העולם הדתי?", a: "כי חלק גדול מהקושי שמביאים לטיפול קשור בעולם שבו חיים: לחצים סביב זוגיות ומשפחה, מתח בין ערכים לבין צרכים אישיים, אמונה שמתערערת או מתחזקת, וחיים בתוך קהילה צפופה. מטפל שלא מכיר את העולם הזה עלול לזהות נכון את התסמין אבל לפרש לא נכון את ההקשר, או לכוון בלי כוונה לפתרונות שאינם אפשריים עבור המטופל. מטפל שמכיר חוסך את שלב ההסבר, ויכול לעבוד בתוך המסגרת ולא נגדה." },
      { q: "האם טיפול פסיכולוגי מתנגש עם אמונה?", a: "לא אמור להתנגש. מטפל מקצועי אינו מנסה לשנות את ערכיו או את אמונתו של המטופל, ומחויב לכבד אותם - זה חלק מהאתיקה של המקצוע. הטיפול עוסק בקושי שהביא אותך: חרדה, דיכאון, משבר, טראומה או קושי בקשר, ועושה זאת בתוך העולם שלך. כשהאמונה עצמה היא חלק מהקושי, מטפל שמכיר את העולם הדתי יוכל לגעת בזה ברגישות ובלי שיפוטיות." },
      { q: "מתי פונים לרב ומתי למטפל?", a: "אלה שני תפקידים שונים שמשלימים זה את זה. לרב פונים בשאלות הלכתיות ורוחניות. למטפל פונים כשיש מצוקה רגשית שנמשכת ופוגעת בתפקוד: חרדה, מצב רוח ירוד לאורך זמן, התפרצויות כעס, קושי בזוגיות או בהורות, או אירוע קשה שלא מרפה. אנשים רבים מתייעצים עם שניהם, ואין בזה סתירה." },
      { q: "האם אפשר לבקש מטפל/ת מאותו מגדר?", a: "כן, וזו בקשה נפוצה ומובנת לגמרי, גם מטעמי צניעות וגם מטעמי נוחות. אפשר לבקש את זה ישירות בשיחה הראשונה. באתר יש גם עמודים שבהם מוצגות רק מטפלות, לפי עיר." },
      { q: "איך בוחרים מטפל?", a: "שלושה דברים קובעים יותר מכל השאר: הכשרה שמתאימה לסוג הקושי, ניסיון עם מקרים דומים, ומה שקורה בפגישה הראשונה. השניים הראשונים ניתנים לבדיקה מראש, ואפשר לשאול עליהם ישירות. השלישי מתברר רק בפועל, וסביר לתת לו שתיים או שלוש פגישות לפני שמחליטים. אם אינך בטוח איזה סוג טיפול מתאים, השאלון שלנו ממפה את הקושי וממליץ על סוג הטיפול לפני שמתחילים לחפש מטפל/ת." },
    ],
    filter: { culturalPrefsAny: ["היכרות עם העולם הדתי"] },
    supplyNote: "מוצגים מטפלים שציינו היכרות עם העולם הדתי",
    related: [
      { href: "/adults", label: "✦ שאלון התאמה למבוגרים" },
  ...
  {
    // The Haredi counterpart - see the comment above for why the wording is
    // "לחרדים" and why it is a separate topic. The supply gate alone selected
    // Jerusalem, Bnei Brak, Beit Shemesh, Ramat Gan, Petah Tikva, Maale Adumim
    // and Migdal HaEmek on 18/9/2026 - the cities with Haredi communities - so
    // it needs no curated city list of its own.
    slug: "פסיכולוג-לחרדים",
    name: "פסיכולוגים לחרדים",
    searchTitle: "פסיכולוגים לחרדים - מטפלים שמכירים את העולם החרדי",
    kind: "community",
    intro:
      "בעולם החרדי ההחלטה ללכת לטיפול כרוכה לא פעם בשאלות שמטפל מבחוץ לא תמיד רואה: מי ידע, איך זה ישפיע על המשפחה, והאם המטפל יבין את אורח החיים בלי לשפוט אותו. מטפל שמכיר את העולם החרדי מכיר את מבנה המשפחה, את עולם הישיבות והכוללים, את מקומו של הרב ואת הרגישות לפרטיות, ועובד בתוך המסגרת הזו. המטפלים כאן ציינו היכרות עם העולם החרדי. חלקם חרדים בעצמם וחלקם לא, ואם זה חשוב לך, כדאי לשאול בשיחה הראשונה.",
    cityTitleTail: "מטפלים שמכירים את העולם החרדי",
    faq: [
      { q: "האם המטפלים בעמוד הזה חרדים בעצמם?", a: "לא בהכרח, וחשוב לומר את זה במפורש. המטפלים שמוצגים כאן ציינו שהם מכירים את העולם החרדי - את אורח החיים, את מבנה המשפחה ואת הרגישויות שבו. חלקם חרדים בעצמם וחלקם לא. עבור רוב המטופלים מה שחשוב באמת הוא שלא יצטרכו להסביר ולהצדיק את עולמם. אם חשוב לך שהמטפל/ת יהיו חרדים בעצמם, זו שאלה לגיטימית לגמרי, ואפשר לשאול אותה ישירות בשיחה הראשונה." },
      { q: "האם הטיפול נשאר חסוי?", a: "כן. מטפלים מחויבים בחיסיון על פי חוק ועל פי כללי האתיקה של המקצוע, ואינם רשאים למסור מידע על מטופל בלי הסכמתו, למעט מצבים חריגים של סכנה ממשית. זו שאלה שמותר ורצוי לשאול בשיחה הראשונה, ומטפל טוב יסביר בדיוק מה נשאר בחדר." },
      { q: "למה חשוב שהמטפל יכיר את העולם החרדי?", a: "כי ההקשר משנה את הפירוש. משפחה גדולה, הפרדה בין גברים לנשים, עולם הישיבות והכוללים, מקומו של הרב, ונורמות שונות סביב טכנולוגיה ותקשורת - מטפל שלא מכיר את כל אלה עלול לראות בעיה במה שהוא בסך הכול אורח חיים, או להציע דרכים שאינן אפשריות עבור המטופל. מטפל שמכיר חוסך את שלב ההסבר, ויכול לעבוד בתוך המסגרת ולא נגדה." },
      { q: "מתי פונים לרב ומתי למטפל?", a: "אלה שני תפקידים שונים שמשלימים זה את זה. לרב פונים בשאלות הלכתיות ורוחניות. למטפל פונים כשיש מצוקה רגשית שנמשכת ופוגעת בתפקוד: חרדה, מצב רוח ירוד לאורך זמן, התפרצויות כעס, קושי בזוגיות או בהורות, או אירוע קשה שלא מרפה. אנשים רבים מתייעצים עם שניהם, ואין בזה סתירה." },
      { q: "האם אפשר לבקש מטפל/ת מאותו מגדר?", a: "כן, ובעולם החרדי זו לרוב בקשה מובנת מאליה. אפשר לבקש את זה ישירות בשיחה הראשונה. באתר יש גם עמודים שבהם מוצגות רק מטפלות, לפי עיר." },
      { q: "איך בוחרים מטפל?", a: "שלושה דברים קובעים יותר מכל השאר: הכשרה שמתאימה לסוג הקושי, ניסיון עם מקרים דומים, ומה שקורה בפגישה הראשונה. השניים הראשונים ניתנים לבדיקה מראש, ואפשר לשאול עליהם ישירות. השלישי מתברר רק בפועל, וסביר לתת לו שתיים או שלוש פגישות לפני שמחליטים. אם אינך בטוח איזה סוג טיפול מתאים, השאלון שלנו ממפה את הקושי וממליץ על סוג הטיפול לפני שמתחילים לחפש מטפל/ת." },
    ],
    filter: { culturalPrefsAny: ["היכרות עם העולם החרדי"] },
    supplyNote: "מוצגים מטפלים שציינו היכרות עם העולם החרדי",
    related: [
      { href: "/adults", label: "✦ שאלון התאמה למבוגרים" },
      { href: "/kids", label: "✦ שאלון התאמה לילדים ונוער" },
      { href: "/research/first-session", label: "הפגישה הראשונה אצל פסיכולוג" },
  ...
  },
  {
    ...
    // page at all.
    //
    // "מטפל רגשי" is every profession that delivers emotional therapy, and a
    // psychologist is one of them. The first version (21/9/2026) read it as
    // "not a psychologist" and left psychologists out; the owner, a clinical
    // psychologist, corrected that the same day, and the intro and FAQ were
    // rewritten to match.
    //
    // What stays out is what does not deliver emotional therapy: occupational
    // psychology (career assessment and guidance - 8 listed therapists hold it
    // alone), educational counselling, and the para-medical professions.
    //
    // With psychologists in, the list sits close to the city page's (Haifa: 15
    // here, 17 there). What sets this page apart is its title, intro and FAQ,
    // so if GSC reports it as a duplicate of the city page, that is the reason.
    slug: "מטפל-רגשי",
    name: "מטפל רגשי",
    searchTitle: "מטפל רגשי - טיפול רגשי אצל מטפלות ומטפלים מאומתים",
    kind: "profession",
    intro:
      "\"מטפל רגשי\" הוא שם כללי למי שמטפל בקשיים רגשיים, והוא כולל כמה מקצועות: פסיכולוגים, עובדים סוציאליים קליניים, מטפלים באמנויות - אמנות, דרמה, תנועה ומוזיקה - ופסיכותרפיסטים. כולם עובדים עם מבוגרים, עם זוגות ועם ילדים, וההבדל ביניהם הוא בסוג ההכשרה ובמה שכל אחד מוסמך לעשות: אבחון פסיכולוגי, למשל, שמור לפסיכולוגים. בטיפול עצמו, מה שמנבא הצלחה יותר מכל הוא הקשר הטיפולי וההתאמה לקושי, ולא התואר. כאן מוצגים מטפלים רגשיים שתעודות ההכשרה שלהם אומתו, לפי עיר.",
    cityTitleTail: "טיפול רגשי אצל מטפלות ומטפלים מאומתים",
    faq: [
      { q: "האם פסיכולוג הוא מטפל רגשי?", a: "כן. \"מטפל רגשי\" הוא שם כללי למי שמטפל בקשיים רגשיים, ופסיכולוג הוא אחד מהם, לצד עובדים סוציאליים קליניים, מטפלים באמנויות ופסיכותרפיסטים. ההבדל ביניהם הוא בהכשרה ובמה שכל אחד מוסמך לעשות: פסיכולוג הוא בעל תואר שני בפסיכולוגיה ורישום בפנקס הפסיכולוגים, והוא המוסמך לבצע אבחון פסיכולוגי. בטיפול עצמו כולם יכולים לעזור מאוד, ומה שמנבא הצלחה יותר מכל הוא הקשר הטיפולי וההתאמה לקושי. אם נדרש אבחון, צריך פסיכולוג. אם נדרש טיפול, כל האפשרויות פתוחות." },
      { q: "האם \"מטפל רגשי\" הוא תואר מוגן?", a: "הביטוי עצמו אינו תואר מוגן, בשונה מ\"פסיכולוג\". לכן כדאי לבדוק מה ההכשרה שעומדת מאחוריו: פסיכולוג, עובד סוציאלי קליני, מטפל באמנויות, פסיכותרפיסט שסיים הכשרה. באתר הזה תעודות ההכשרה של כל המטפלים אומתו, וההכשרה המדויקת של כל אחד מופיעה בכרטיס שלו." },
      ...
      { q: "האם מטפל רגשי מטפל גם בילדים?", a: "רבים כן, ובמיוחד פסיכולוגים חינוכיים והתפתחותיים ומטפלים באמנויות, שעבודה דרך משחק ויצירה מתאימה לילדים באופן טבעי. בכרטיס של כל מטפל מופיע עם אילו גילאים הוא עובד. לחיפוש ממוקד בילדים יש באתר גם עמודים של פסיכולוגים ומטפלים רגשיים לילדים, לפי עיר." },
    ...
    filter: {
      therapistTypesAny: [
        ...
        'עו"ס קליני', "מטפל/ת בהבעה ויצירה", "מטפל מיני", "קרימינולוג קליני", "פסיכותרפיסט",
      ],
    },
    supplyNote: "מוצגים מטפלים רגשיים - פסיכולוגים, עובדים סוציאליים קליניים, מטפלים באמנויות ואנשי טיפול נוספים - שתעודות ההכשרה שלהם אומתו",
    related: [
      { href: "/adults", label: "✦ שאלון התאמה למבוגרים" },
