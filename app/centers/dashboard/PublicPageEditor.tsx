    ...
    <section className="mb-8 rounded-2xl border border-teal-200 bg-teal-50/40 p-5">
      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-2">
        ...
        <div>
          ...
          <input value={phone} onChange={(e) => setPhone(e.target.value)} dir="ltr" placeholder="למשל 072-1234567 או 03-1234567"
            className="w-full rounded-lg border border-stone-300 px-3 py-2 text-sm outline-none focus:border-[var(--teal)]" />
      ...
      <div className="mt-3 rounded-xl border border-green-200 bg-green-50/60 p-3">
        ...
        <input value={whatsapp} onChange={(e) => setWhatsapp(e.target.value)} dir="ltr" inputMode="tel" placeholder="למשל 052-1234567 או 072-1234567"
        ...
        {(() => {
          ...
          // וואטסאפ עסקי עובד גם על קו נייח או וירטואלי (23/9/26, מרכז עם קו 072).
