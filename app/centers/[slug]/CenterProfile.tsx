        ...
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[var(--line)] bg-white/95 backdrop-blur lg:hidden"
          ...
          <div className="mx-auto flex max-w-[720px] items-center justify-center gap-2 px-4 py-2.5">
            ...
            {telHref && (entity ? (
              ...
              <a href={telHref} className={`inline-flex items-center justify-center gap-1.5 rounded-full bg-[var(--teal)] px-4 py-2.5 text-[14px] font-extrabold text-white transition hover:bg-[var(--teal-dark)] ${waHref ? "" : "flex-1"}`}>
                <Phone size={15} /> חיוג
              </a>
            ))}
            {canMessage && (
