...
// רשומה אחת שמאגדת שני אנשים ("פלונית אלמונית וד\"ר ישראל ישראלי") - כל שרטוט מגדרי
...
export default function CenterProfile({ center, entity, assets, viewSource, therapists }: {
  ...
  // הוואטסאפ העסקי (15/9/2026) קודם; בלעדיו - הטלפון לחיוג אם הוא נייד, כמו
  // שהיה. מרכזייה לא מקבלת כפתור: wa.me לקו נייח פותח שיחה ריקה (תוקן 21/8).
  const waHref = waLinkForCenter(centerWhatsAppNumber(center.public_whatsapp, phone));
