...
function updPQ(A: Ans, k: string, v: string): Ans {
  const n = { ...A, [k]: v };
  n.pq_tot = ["pq1","pq2","pq3","pq4","pq5","pq6","pq7","pq8","pq9","pq10",
...
// ── p-pq ─────────────────────────────────────────────────────────────────────
const PQ_ITEMS = [
  {key:"pq1",  label:"1. אני לא מתעניין/נת בדברים שבעבר הייתי רגיל/ה להנות מהם"},
  {key:"pq2",  label:"2. כאשר אני מביט/ה באדם אחר, או כאשר אני מביט/ה על עצמי במראה, אני רואה שהפנים שלי משתנות ממש לנגד עיני"},
  {key:"pq3",  label:"3. לעיתים קרובות יש לי תחושה שדברים שקורים כרגע כבר קרו לי בעבר"},
  {key:"pq4",  label:"4. לעיתים אני מריח/ה או מרגיש/ה טעמים של דברים כאשר אנשים אחרים אומרים שהם לא מריחים או מרגישים כלום"},
  {key:"pq5",  label:"5. קרה לי ששמעתי דברים כמו קולות של אנשים, לחישות או דיבורים כאשר אנשים אחרים אמרו שהם לא שומעים כלום"},
  {key:"pq6",  label:"6. לעיתים קרובות אני שומע/ת רגשות לא רגילים, כמו דיפקות, נקישות, לחישות, מחיאות כפיים או צלצולים באוזניים"},
  {key:"pq7",  label:"7. אני מרגיש/ה לפעמים שלאחרים יש משהו נגדי"},
  {key:"pq8",  label:"8. לפעמים אני מרגיש/ה שאני לא שולט/ת על הרעיונות ועל המחשבות שלי"},
  {key:"pq9",  label:"9. לפעמים קורה לי שקולות רחוקים שבאופן רגיל אני לא מודע להם פתאום מסיחים את דעתי"},
  {key:"pq10", label:"10. היתה לי תחושה שאדם מסויים או כוח מסויים נמצא סביבי, למרות שלא יכולתי לראות אף אחד"},
  {key:"pq11", label:"11. קרה לי שהייתי מבולבל/ת או לא בטוח/ה האם משהו שחוויתי היה אמיתי או דמיוני"},
  {key:"pq12", label:"12. אני מרגיש/ה שחלקים מגופי השתנו בדרך מסויימת, או שחלקים מגופי עובדים בדרך אחרת מאשר הם עבדו קודם לכן"},
  {key:"pq13", label:"13. המחשבות שלי כל כך חזקות לעיתים, שאני כמעט ושומע/ת אותן"},
  {key:"pq14", label:"14. לעיתים אני מוצא/ת משמעות מיוחדת בפרסומות, חלונות ראווה או באופן בו דברים מאורגנים סביבי"},
  {key:"pq15", label:"15. אני נעשה/ית מאוד חרד/ה כאשר אני נפגש/ת עם אנשים בפעם הראשונה"},
  {key:"pq16", label:"16. ראיתי דברים שאנשים אחרים לא יכולים לראות"},
];
