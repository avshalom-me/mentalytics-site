    ...
    <div>
      ...
      <details className="mb-5 rounded-xl p-4" style={{ background: "var(--surface)", border: "1px solid var(--line)" }}>
        ...
        <div className="mt-3 leading-relaxed" style={{ color: "var(--text-2)" }}>
          ...
          <p className="mb-3 text-sm">האחריות המקצועית וההחלטות נשארות בידי הממלא/ת ובידי הגורמים המוסמכים. הטיוטות נשמרות בדפדפן שבו מולא השאלון בלבד ואינן נשלחות לשרת. הגורמים המפעילים את הכלי אינם נושאים באחריות לנזק, ישיר או עקיף, שייגרם כתוצאה מהשימוש בו.</p>
