...
**אם הומלצה גישה זוגית ספציפית** (הכותרת כוללת "בהעדפה ל..." — EFT/גישה דינמית/גישה מבנית): הסבר במפורש למה דווקא הגישה הזו נמצאה מתאימה למה שתואר בשאלון (היעזר ב-treatment_rationale.why ובשורת "גישה זוגית שנמצאה מתאימה" שב-user_facts). הבהר שזו העדפה ולא בלעדיות — טיפול זוגי בגישות אחרות עשוי גם להתאים, וכדאי לבדוק זאת מול המטפל/ת.
