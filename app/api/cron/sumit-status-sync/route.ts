...
export async function GET(req: NextRequest) {
  ...
  for (const t of paidTherapists ?? []) {
    ...
    try {
      ...
      // תבנית מאושרת (הבהרת 19/8): ההודעה יוצאת, כי שורש התקלה שבה מטפל משלם
      // הושעה בגלל כשל חיוב טכני תוקן - סטטוס ביניים כבר לא נקרא כביטול, ורק
      // ביטול מאושש מגיע לכאן.
  ...
  // כשל חיוב טכני אצל מטפל משלם שלח לו "החיוב נכשל", והוא שילם בהצלחה ארבע
  // שעות אחר כך.
