    ...
    <main className="mx-auto max-w-3xl px-5 py-12 pb-20" dir="rtl" style={{ fontFamily: "'Heebo', sans-serif" }}>
      ...
      <div className="space-y-8 text-stone-700 leading-7">
        ...
        <section>
          ...
          <p>
            ברוכים הבאים ל-Mentalytics. השימוש באתר ובשירותים מהווה הסכמה לתנאי שימוש אלו. אם אינך מסכים לתנאים, אנא הימנע משימוש בשירות.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Mentalytics היא מערכת <strong>הכוונה והפניה בלבד</strong>. השאלונים והתוצאות אינם מהווים אבחון רפואי, פסיכולוגי או נפשי, ואינם תחליף לייעוץ מקצועי. ההחלטה הסופית על בחירת מטפל היא של המשתמש בלבד.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            Mentalytics שומרת לעצמה את הזכות לדחות, להשהות או להסיר פרופיל של מטפל לפי שיקול דעתה, לרבות במקרה של מידע שגוי.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Mentalytics אינה אחראית לאיכות הטיפול הניתן על ידי מטפלים המופיעים במערכת, לנזקים ישירים או עקיפים הנובעים משימוש בשירות, או לתוצאות הטיפול. הקשר הטיפולי הוא בין המטפל למטופל בלבד.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            כל התוכן באתר — טקסטים, עיצוב, שאלונים ואלגוריתמי ההתאמה — הוא רכושה של Mentalytics ומוגן בזכויות יוצרים. אין להעתיק, לשכפל או להשתמש בתוכן ללא אישור מפורש בכתב.
          </p>
        </section>
